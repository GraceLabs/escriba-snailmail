...
.parchment-container { 
    ...
    padding: 50px 60px; color: #2b1d0e; 
    font-family: 'EB Garamond', serif; font-size: 1.7rem; 
    line-height: 1.8; margin-bottom: 30px; 
}
.parchment-container h1, .parchment-container h2, .parchment-container h3 { font-family: 'MedievalSharp', cursive; color: #5c3a1e; border-bottom: 1px solid #8b6914; padding-bottom: 10px; margin-top: 30px; font-size: 2.2rem; }
...
# ==========================================
# PROMPT ATUALIZADO COM CONTROLE DE TAMANHO
# ==========================================
...
if gerar_btn:
    if not personagem or not historia:
        ...
        # Calcula os parágrafos para a IA entender
        paragrafos_esperados = paginas_por_carta * 3
        # Calcula os tokens (palavras) máximos permitidos na API para não cortar o texto
        ...
        with st.spinner(f'Preparando a tinta... Redigindo {divisoes} cartas de {paginas_por_carta} páginas cada.'):
            try:
                ...
                # Injeta o tamanho exato no prompt do usuário
                ...
                response = client.chat.completions.create(
                    ...
                    temperature=0.7,
                    max_tokens=max_tokens # Limita o tamanho pela API também
                )
